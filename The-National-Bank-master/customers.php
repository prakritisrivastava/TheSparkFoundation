...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <div class="container-fluid">
    <a class="navbar-brand" href="#">The National Bank </a>
...
<body style="background-image : url(img/bg2.jpg)" width="100">
<?php
    include 'config.php';
...
<div class="container">
        ...
        <br>
         ...
         <footer class="text-center mt-5 py-2">
            <p>&copy 2021 <b>Prakrity Srivastava</b> <br>The Sparks Foundations</p>
        </footer>
